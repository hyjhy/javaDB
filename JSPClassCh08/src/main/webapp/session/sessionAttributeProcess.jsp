...
<body>
	<table>
		...
		<tr>
			...
			<td class="content">${sessionScope.member.gender == null ? "입력않됨" : sessionScope.member.gender}</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="content">${sessionScope.member.noticeMail ? "공지메일 받음" : "공지메일 받지 않음" }</td>
		</tr>
		<tr>
			<td class="content">${sessionScope.member.addMail ? "광고메일 받음" : "광고메일 받지 않음" }</td>
		</tr>
		<tr>
			<td class="content">${sessionScope.member.infoMail ? "정보메일 받음" : "정보메일 받지 않음" }</td>
		</tr>
		<tr>
